...
data_path = "C:\\Users\\kingp\\Documents\\classify\\dataset"  # import the dataset
...
filename = "C:\\Users\\kingp\\Documents\\classify\\model_checkpoint.pth" #location of downloaded resnet152 model
...
def train (model,dataloader, loss_fn, optimizer, decay, file_name, num_epochs):
    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train','valid']: # training and validation 
            if phase =='train':
                model.train()
            else:
                model.eval()
            ...
            running_loss = 0.0
            running_corrects=0
            current_loader=dataloader[phase]
            ...
            if phase == 'valid' and epoch_acc > best_acc: #update best accuracy
                ...
                torch.save(state, os.path.join('C:\\Users\\kingp\\.cache\\torch\\hub\\checkpoints', 'model_checkpoint.pth'))
